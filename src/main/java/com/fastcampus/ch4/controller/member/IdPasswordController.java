...
public class IdPasswordController {
    ...
    @Autowired
    private MemberService memberService; // MemberService를 자동으로 주입
    ...
    public String findId(
        ...
        String id = memberService.findUsernameByEmail(email);

        if (id != null) {
            redirectAttributes.addFlashAttribute("id", id); // "id"라는 이름으로 플래시 속성 설정
        } else {
    ...
    public String findPassword(
        ...
        String password = memberService.findPasswordByEmailAndId(email, id);
