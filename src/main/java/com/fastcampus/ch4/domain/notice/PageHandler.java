...
public class PageHandler {
    ...
    // 값의 유효성을 검사하는 게 service나 controller에서 하는 게 맞는 건지
    // 아니면 여기서도 이중으로 하기도 하는지...?
    // 근데 유효성검사 후 에러메시지를 띄울 게 아니라 기본값으로 넣어줄 건데.......
    // 아! 전체 페이지수를 알아야만 해당 페이지가 유효한지 아닌지 알 수 있다!
    // (전체 페이지수보다 현재 패이지 번호가 작거나 같아야 하니까..!)
